...
adams({ nomCom: "support", categorie: "General" }, async (dest, zk, commandeOptions) => {
  ...
  repondre("THANK YOU FOR CHOOSING masterpeace-techbot, contact masterpeace elite at 254743727510) 
  await zk.sendMessage(auteurMessage,{text : `THANK YOU FOR CHOOSING mastertech-elite-MD, `},{quoted :ms})
